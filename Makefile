...
test: test test-self-hosted test-supplemental
...
test-self-hosted: all
	#$(RUN_TEST_CMD) step2_eval.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step3_env.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step4_if_fn_do.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step5_tco.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step6_file.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step7_quote.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step8_macros.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) step9_try.mal ../../self_hosted_run
	#$(RUN_TEST_CMD) stepA_mal.mal ../../self_hosted_run
